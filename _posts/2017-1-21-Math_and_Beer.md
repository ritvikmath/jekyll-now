  ...
  <script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
    ...
    function drawChart() {
      ...
      data.addRows([
        ...
        24.0, 8.5, 10.1, 15.0, 30.0]
        [27.0, 8.6, 11.7, 11.5, 24.4]
        [30.0, 8.2, 8.4, 15.2, 23.2],
        [33.0, 10.7, 11.1, 17.1, 27.8
        [36.0, 7.9, 10.3, 10.0, 23.6]
        [39.0, 6.5, 7.8, 18.0, 30.1],
        [42.0, 9.5, 10.0, 20.9, 34.2]
        [45.0, 8.6, 7.7, 12.6, 27.8],
        [48.0, 8.8, 9.3, 12.7, 26.1],
        [51.0, 7.8, 7.7, 17.4, 48.0],
        [54.0, 7.8, 9.4, 17.0, 30.0],
        [57.0, 8.0, 7.8, 12.1, 51.3],
