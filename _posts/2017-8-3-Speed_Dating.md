...
<script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        data.addRows([
			['Prefers Shared Interests', 'Chose Shared Interests', 0.1],
			['Prefers Fun', 'Chose Sincerity', 0.15],
			['Prefers Fun', 'Chose Attractiveness', 0.31],
			['Prefers Attractiveness', 'Chose Fun', 0.09],
			['Prefers Shared Interests', 'Chose Ambition', 0.1],
			['Prefers Fun', 'Chose Fun', 0.08],
			['Prefers Shared Interests', 'Chose Sincerity', 0.3],
			['Prefers Attractiveness', 'Chose Attractiveness', 0.31],
			['Prefers Sincerity', 'Chose Shared Interests', 0.01],
			['Prefers Intelligence', 'Chose Sincerity', 0.26],
			['Prefers Attractiveness', 'Chose Shared Interests', 0.01],
			['Prefers Ambition', 'Chose Fun', 0.2],
			['Prefers Sincerity', 'Chose Attractiveness', 0.34],
			['Prefers Intelligence', 'Chose Shared Interests', 0.03],
			['Prefers Ambition', 'Chose Intelligence', 0.6],
			['Prefers Sincerity', 'Chose Ambition', 0.08],
			['Prefers Shared Interests', 'Chose Attractiveness', 0.4],
			['Prefers Intelligence', 'Chose Fun', 0.06],
			['Prefers Sincerity', 'Chose Fun', 0.09],
			['Prefers Intelligence', 'Chose Attractiveness', 0.32],
			['Prefers Attractiveness', 'Chose Sincerity', 0.28],
			['Prefers Sincerity', 'Chose Sincerity', 0.27],
			['Prefers Attractiveness', 'Chose Intelligence', 0.26],
			['Prefers Sincerity', 'Chose Intelligence', 0.21],
			['Prefers Intelligence', 'Chose Ambition', 0.03],
			['Prefers Attractiveness', 'Chose Ambition', 0.05],
			['Prefers Fun', 'Chose Intelligence', 0.38],
			['Prefers Ambition', 'Chose Sincerity', 0.2],
			['Prefers Shared Interests', 'Chose Intelligence', 0.1],
			['Prefers Fun', 'Chose Ambition', 0.08],
			['Prefers Intelligence', 'Chose Intelligence', 0.3]
        ]);
